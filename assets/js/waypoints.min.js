        ...
        for (var r in t) {
          ...
          for (var s in this.waypoints[r]) {
            var a,
              ...
              p,
              u,
              c = this.waypoints[r][s],
              d = c.options.offset,
              f = c.triggerPoint,
              w = 0,
              y = null == f;
            c.element !== c.element.window &&
              (w = c.adapter.offset()[n.offsetProp]),
              "function" == typeof d
                ? (d = d.apply(c))
                : "string" == typeof d &&
                  ((d = parseFloat(d)),
              ...
              (l = f < n.oldScroll),
              (h = c.triggerPoint >= n.oldScroll),
              (p = l && h),
              (u = !l && !h),
              !y && p
                ? (c.queueTrigger(n.backward), (o[c.group.id] = c.group))
                : !y && u
                ? (c.queueTrigger(n.forward), (o[c.group.id] = c.group))
                : y &&
                  n.oldScroll >= c.triggerPoint &&
                  (c.queueTrigger(n.forward), (o[c.group.id] = c.group));
          }
        }
